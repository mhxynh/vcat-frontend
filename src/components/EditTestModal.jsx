  ...
  return (
    ...
    >
      <Modal.Header
        ...
        title={`Edit Control Test: ${selectedVgcpid || '-'}`}
        titleId="edit-test-title"
        onClose={onClose}
      />
      ...
      >
        {loading ? (
          ...
          <FormGrid className="ctm-grid">
            <FormField label="VGCPID" required error={fieldErrors.selectedControlId}>
              <FormSelect
