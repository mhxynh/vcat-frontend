          ...
          <div className="ctm-grid">
            <div className="ctm-field">
              <label className="ctm-label">
                VGCPID <span className="ctm-req" aria-hidden="true">*</span>{' '}
              </label>
              <select
            ...
            <div className="ctm-field">
              <label className="ctm-label">
                Test Type <span className="ctm-req" aria-hidden="true">*</span>
              </label>
              <select
                className="ctm-select"
                value={testType}
            ...
            <div className="ctm-field">
              <label className="ctm-label">
                Due Date <span className="ctm-req" aria-hidden="true">*</span>
              </label>
              <input
                className="ctm-input"
                type="date"
            ...
            <div className="ctm-field ctm-field--full">
              <label className="ctm-label">
                Description <span className="ctm-req" aria-hidden="true">*</span>{' '}
              </label>
              <textarea
