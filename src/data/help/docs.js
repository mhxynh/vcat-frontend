...
export const HELP_DOCS = [
  ...
  {
    id: 'manager-workflow',
    title: 'Manager End-to-End Workflow',
    categoryId: 'admin',
    order: 15,
    summary:
      'Step-by-step walkthrough of how managers plan, create, assign, and track testing cycles.',
    roles: [ROLES.MANAGER],
    permissions: [
    ...
    keywords: ['manager', 'workflow', 'planning', 'create', 'assign', 'track', 'end-to-end'],
    media: {
      type: HELP_MEDIA_TYPES.VIDEO,
      src: '/help-assets/manager-workflow.mp4',
      poster: '/help-assets/manager-workflow-poster.png',
      title: 'Manager workflow walkthrough',
    },
    sections: [
      {
        type: HELP_SECTION_TYPES.PARAGRAPH,
        body: 'As a Manager, your role is to plan testing cycles, create testing containers (Requests and Tests), assign work to Testers, and track progress. Here is the complete workflow from planning to completion.',
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 1: Plan your testing cycle',
        items: [
          'Determine which Controls need to be tested (e.g., all "Active" controls, or controls requested by auditors).',
          'Decide on the scope of work: How many Controls? What test types (DAT, OET, or both)? What is the due date?',
          'Estimate the total effort and determine which Testers to assign. Use the Dashboard to check Available Bandwidth.',
          'Set a target completion date and communicate timelines to stakeholders.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 2: Set up Controls (if not already created)',
        items: [
          'Navigate to the Catalog → Controls tab.',
          'Click "Create Control" or use "Import" to bulk-load many controls at once.',
          'If creating manually: Enter VGCPID, Description, Owner, SME, and Escalation details. Save.',
          'If importing: Download the template, fill in data, validate, and confirm import.',
          'Verify all Controls appear in the list and are marked "Active."',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 3: Create a Request',
        items: [
          'Navigate to the Requests tab.',
          'Click "Create Request." Enter Requestor (e.g., "Internal Audit"), Priority, Due Date, and Description.',
          'Save. The Request will appear in the list with status "Open." Note the Request ID (you will need it for creating Tests).',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 4: Create Tests for your Request',
        items: [
          'In the Requests view, click your Request row to open details.',
          'Click "Create Test." Select the Control, Test Type (DAT, OET, or Both), Priority, and Due Date.',
          'Repeat for each Control you want to test. Or, use the bulk create option if you have many Controls to add.',
          'Verify all Tests appear in the Request view with status "Unassigned."',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 5: Assign Tests to Testers',
        items: [
          'Check the Dashboard to see Tester Available Bandwidth and current workload.',
          'In the Tracker or Request view, select Tests to assign. You can filter to show "Unassigned" Tests.',
          'Click "Assign" or "Bulk Assign." Select the Tester and confirm. Tests will move to "Assigned" status.',
          "Verify assignments in the Tracker or by checking the Tester's dashboard.",
          'Communicate due dates and priorities to assigned Testers via comment or email.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 6: Monitor progress',
        items: [
          'Check the Dashboard daily or weekly to see overall progress: % Complete, At Risk, Blocked.',
          'Use the Tracker to filter by status (In Progress, Blocked, Complete) and priority (High, Medium, Low).',
          'Use the Calendar to see which Tests are due soon and which are overdue.',
          'Review comments from Testers for blockers or questions. Add clarifying comments or take action.',
          'If a Tester is overloaded or blocked, reassign their work or unblock them.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 7: Handle workflow transitions',
        items: [
          'As Testers update Tests (mark as "DAT Passed," "In Progress," etc.), you will see status changes in real-time.',
          'Some workflow transitions may require Manager approval. Review and approve as needed.',
          'If a Test cannot move forward due to a missing field or evidence, add a comment explaining what is needed.',
          'Monitor for "Blocked" status and work with Testers to resolve blockers.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 8: Export and report',
        items: [
          'When the testing cycle is near completion or at a checkpoint, export data for reporting.',
          'Use the "Export" button in the Requests or Tracker view. Download .csv or .xlsx format.',
          'Use exported data for executive reports, audit evidence, or compliance filings.',
          'Archive or mark the Request as "Complete" when all Tests are done.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.TIP,
        body: 'Regularly communicate with Testers about progress, blockers, and due dates. The sooner you unblock work, the sooner the cycle completes.',
      },
      {
        type: HELP_SECTION_TYPES.WARNING,
        body: 'Do not create all Tests without assigning them. Unassigned Tests may be forgotten. Assign immediately after creation.',
      },
    ],
  },
  {
  ...
  {
    id: 'tester-workflow',
    title: 'Tester End-to-End Workflow',
    categoryId: 'testing',
    order: 40,
    summary:
      'Step-by-step guide for testers: from receiving assignments to completing tests and documenting findings.',
    roles: [ROLES.TESTER],
    permissions: [ACTIONS.VIEW_TESTS, ACTIONS.UPDATE_TEST, ACTIONS.COMMENT],
    keywords: [
      'tester',
    ...
    media: {
      type: HELP_MEDIA_TYPES.VIDEO,
      src: '/help-assets/tester-workflow.mp4',
      poster: '/help-assets/tester-workflow-poster.png',
      title: 'Tester end-to-end workflow walkthrough',
    },
    sections: [
      {
        type: HELP_SECTION_TYPES.PARAGRAPH,
        body: 'As a Tester, your role is to execute assigned tests, document your findings, and move tests through the workflow. Here is the complete journey from receiving an assignment to marking a test complete.',
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 1: Receive assignment notification',
        items: [
          'Your Manager assigns you one or more Tests via the "Assign" or "Bulk Assign" action.',
          'You will receive an in-app notification (check the notification bell in the top navigation).',
          'Your Manager may also email or message you with details about the Request and due date.',
          'Note the due date, priority level (High/Medium/Low), and any special instructions from your Manager.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 2: View your assigned tests',
        items: [
          'Navigate to Tracker in the top navigation. You will see all Tests assigned to you.',
          'Filter by "Status = Assigned" to see newly assigned Tests that you have not yet started.',
          'Review the list to understand scope: How many Tests? What Controls? What are the due dates?',
          'Prioritize by due date or priority level. Tackle high-priority and soon-to-be-due Tests first.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 3: Open test details',
        items: [
          'Click on a Test row to open the test details modal.',
          'You will see: Control details (VGCPID, Description, Owner, SME), Test Type (DAT, OET, or Both), current Status, and any Manager comments.',
          'Read the control description and any requirements or context your Manager provided.',
          'If you have questions, add a comment and tag your Manager (@Manager) to get clarification.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 4: Execute the test',
        items: [
          'Review the control design and operational procedures.',
          'Gather evidence or documentation that demonstrates the control is in place and working.',
          'For DAT (Design testing): Verify the control is designed to mitigate risk.',
          'For OET (Operational testing): Verify the control is actually operating as designed.',
          'Document your findings: What you tested, what you observed, any issues or exceptions.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 5: Update the test status',
        items: [
          'In the test details modal, click the Status dropdown to change status.',
          'Select the next status based on your findings:',
          '  - "In Progress": You have started but not finished the test.',
          '  - "DAT Passed": You completed design testing and the control is well-designed.',
          '  - "DAT Failed": You completed design testing and found the control is not well-designed.',
          '  - "OET Passed": You completed operational testing and the control is operating effectively.',
          '  - "OET Failed": You completed operational testing and found the control is not operating effectively.',
          '  - "Complete": You have finished all required test types (DAT and/or OET) and are ready for closure.',
          'Click Save. The status will update immediately.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 6: Add comments and evidence',
        items: [
          'In the test details modal, scroll to the "Comments" section.',
          'Click "Add Comment" and type your findings, decisions, or blockers.',
          'If you need clarification from your Manager, tag them: @Manager or use their name if you see it suggested.',
          'Attach evidence files (screenshots, documents, logs). Click "Add Attachment" and upload or paste a link.',
          'Save your comment. It will appear in the audit trail and notify your Manager.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 7: Handle blockers',
        items: [
          'If you cannot complete the test (e.g., missing access, unclear requirements), add a comment explaining the blocker.',
          'Change the status to "Blocked" and wait for your Manager to unblock you.',
          'Your Manager may provide more context, grant access, or reassign the test.',
          'Once unblocked, resume testing and update the status again.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 8: Mark test complete',
        items: [
          'Once you have completed all required test work (DAT and/or OET), change status to "Complete."',
          'Verify you have:',
          '  - Updated the status to reflect your testing outcome (Passed/Failed).',
          '  - Added clear comments explaining your findings.',
          '  - Attached all evidence (documents, screenshots, logs) supporting your decision.',
          'Click Save. Your Manager will review and may request additional work or sign off on closure.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.STEPS,
        title: 'Step 9: Monitor progress',
        items: [
          'Check the Dashboard to see your personal testing progress and workload.',
          'Use the Calendar view to ensure you are not missing due dates.',
          'Use Kanban view to see your Tests grouped by status and move them through the workflow.',
          'Respond promptly to Manager comments or requests for clarification.',
        ],
      },
      {
        type: HELP_SECTION_TYPES.TIP,
        body: 'Update test status and add comments frequently, even if the test is not complete. This keeps your Manager informed and prevents surprises near the due date.',
      },
      {
        type: HELP_SECTION_TYPES.WARNING,
        body: 'Do not mark a test as "Complete" unless you are truly finished with all required work. Incomplete tests marked complete can delay reporting and compliance deadlines.',
      },
    ],
  },
  {
